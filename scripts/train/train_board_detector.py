...
script.add_argument(
    ...
    dest="dataset_path",
    type=str,
    default="/home/hp/datasets/augmented_boards_512",
)
script.add_argument(
    "-m", dest="model", choices=["MobileViTV2FPN"], default="MobileViTV2FPN"
)
...
def train(args):
    ...
    base_model_class = {"MobileViTV2FPN": MobileViTV2FPN}[args.model]

    if args.checkpoint is not None:
        model = BoardDetector.load_from_checkpoint(
            args.checkpoint, base_model_class=base_model_class
        )
    else:
        model = BoardDetector(base_model_class=base_model_class)
